...
class Smslog extends BaseModel {
     ...
     * @return type
     */
    public function getSmsList($condition = array(), $page = '', $limit = 0, $order = 'smslog_id desc') {
        if ($page) {
            $result = Db::name('smslog')->where($condition)->order($order)->paginate(['list_rows'=>$page,'query' => request()->param()],false);
