...
class Database extends AdminControl
{
    ...
    public function index()
    {
        ...
        View::assign('list', $dbtables);
        View::assign('total', format_bytes($total));
        View::assign('tableNum', count($dbtables));
        $this->setAdminCurItem('db');
        return View::fetch('db');
    }
    ...
    public function optimize()
    {
        ...
        $this->success("优化表成功" . $strTable, url('admin/Database/index'));
    }
    ...
    public function repair()
    {
        ...
        $this->success("修复表成功" . $strTable, url('admin/Database/index'));
    }
